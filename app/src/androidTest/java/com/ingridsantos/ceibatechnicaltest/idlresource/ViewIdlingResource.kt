package com.ingridsantos.ceibatechnicaltest.idlresource
...
class ViewIdlingResource(
    ...
    override fun registerIdleTransitionCallback(resource: IdlingResource.ResourceCallback?) {
        this.resourceCallback = resource
    }
...
fun waitUntilViewIsNotDisplayed(matcher: Matcher<View?>) {
    val idlingResource: IdlingResource = ViewIdlingResource(
        matcher,
